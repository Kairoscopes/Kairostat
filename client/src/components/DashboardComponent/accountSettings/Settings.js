        ...
        <div>
          ...
          <form onSubmit={this.handleSubmit} style={{ float: "center" }}>
            ...
            <Center>
              <div>
                <div class="img-align">
                  <img src={this.state.data.imgLink}/>
                </div>
                <br />
                <br />
                <div class="img-align">
                  <span style={{ fontWeight: "bold" }}>Karma: {this.state.data.karma}</span>
                </div>
                <br />
                <br />
                <span style={{ fontWeight: "bold" }}>Picture</span>
                <br />
                <TextField name='imgLink'
                  type="text"
                  hintText="https://i.imgur.com/6eOlEUB.jpg"
            ...
            <Center>
              ...
              <div><RaisedButton label="Cancel" type="button" buttonStyle={cancelButtonStyle} onClick={() =>
